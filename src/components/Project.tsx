...
const projectData: ProjectData[] = [
  {
    ...
    description: "AI-powered system that converts text prompts into coherent short-form videos",
    ...
    techStack: ["Large Language Models (LLM)", "Edge-TTS", "FFmpeg", "Pexels/Pixabay APIs", "Custom Video Library"],
  ...
  },
  {
    ...
    description: "React-based CCS with AI-powered tagging and multimedia content generation",
    ...
    techStack: ["React", "Node.js", "MongoDB", "LLM", "AWS S3", "Selenium", "SERP API"],
    image: "/api/placeholder/500/300",
    link: "#",
  ...
  },
  {
    ...
    description: "Full-featured project management platform with workflows, resource allocation and reporting",
...
function Project() {
  ...
  const allTechStacks = Array.from(
    new Set(
      projectData.flatMap(project => project.techStack)
    )
  );
  ...
  return (
    <div className="projects-container" id="projects">
      <h1 className="text-center my-4">Personal Projects</h1>
      ...
      {filteredProjects.length > 0 ? (
        <div className="projects-grid">
          {filteredProjects.map((project) => (
            <div 
              className={`project-card ${animatedItems.includes(project.id) ? 'animated' : ''}`} 
              key={project.id}
              data-id={project.id}
            >
              ...
              <div className="project-info">
                ...
                <div className="project-tech-stack">
                  ...
                  {project.techStack.length > 3 && (
                    <span className="tech-badge more-badge">+{project.techStack.length - 3}</span>
                  )}
                </div>
                <div className="project-links">
                  ...
                  <a href={project.link} target="_blank" rel="noreferrer" className="demo-link">
          ...
          <div className="project-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-links">
              {selectedProject.github && (
                <a href={selectedProject.github} target="_blank" rel="noreferrer" className="github-link">
                  <i className="fab fa-github"></i> View Code
                </a>
              )}
              <a href={selectedProject.link} target="_blank" rel="noreferrer" className="demo-link">
